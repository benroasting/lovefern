...
import { LovefernImage } from "@/app/components/LovefernImage";
  ...
  return (
    <View style={styles.detailsContainer}>
      <View style={{ alignItems: "center" }}>
        <LovefernImage imageUri={plant.imageUri} />
      ...
      <CustomButton title="Water me!" onPress={handleWaterPlant} />
